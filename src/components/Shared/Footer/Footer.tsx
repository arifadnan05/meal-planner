...
const Footer = () => {
    return (
        <div>
            <footer className="bg-[#100F0B] dark:bg-white">
                    ...
                    <div className="lg:flex">
                        <div className="w-full -mx-6 lg:w-2/5">
                            <div className="px-6">
                                ...
                                <div className="flex mt-6 -mx-2">
                                    <a href="#"
                                        className="mx-2 text-gray-100 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400"
                                        aria-label="Reddit">
                        ...
                        <div className="mt-6 lg:mt-0 lg:flex-1">
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                <div>
                                    <h3 className="text-gray-100 uppercase dark:text-white">About</h3>
                                    <a href="#" className="block mt-2 text-sm text-gray-100 dark:text-gray-100 hover:underline">Company</a>
                                    <a href="#" className="block mt-2 text-sm text-gray-100 dark:text-gray-100 hover:underline">community</a>
                                    <a href="#" className="block mt-2 text-sm text-gray-100 dark:text-gray-100 hover:underline">Careers</a>
                                </div>

                                <div>
                                    <h3 className="text-gray-100 uppercase dark:text-white">Blog</h3>
                                    <a href="#" className="block mt-2 text-sm text-gray-100 dark:text-gray-100 hover:underline">Tec</a>
                                ...
                                <div>
                                    ...
                                    <span className="block mt-2 text-sm text-gray-100 dark:text-gray-100 hover:underline">example@email.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
